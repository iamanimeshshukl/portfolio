...
<div class="flex items-center gap-4">
  <div class="social-button">
    <a href='https://www.instagram.com/animesh.ai?igsh=MWZtdXQzZWJod2ZraA=='><button class="relative w-12 h-12 rounded-full group">
  ...
  <div class="social-button">
    <a href='https://github.com/iamanimeshshukl'><button class="relative w-12 h-12 rounded-full group">
      <div
  ...
  <div class="social-button">
   <a href='https://www.linkedin.com/in/animesh-shukl?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app'> <button class="relative w-12 h-12 rounded-full group">
      <div
