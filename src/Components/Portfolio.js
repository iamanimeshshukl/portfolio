...
const Portfolio = () => {
  ...
  return (
    <div className='mt-5 flex justify-center flex-col'>
       ...
       <div>
         <div className='grid grid-cols-1 items-center content-center md:grid-cols-3 lg:grid-cols-4
        md:px-24 lg:px-48 p-4 '>
                ...
                transition-all ease-in-out group hover:scale-110'>
                  <a href='https://monkeycloth.vercel.app/'> <img src={img1} className="h-[180px] w-full rounded-lg"/>
                    <h1 className='text-[14px] group-hover:scale-110 mt-2 text-center  font-bold text-white'>Monkey</h1>
                    <h1 className='text-[12px] text-white px-6 pb-3'>Visit my full-stack e-commerce project, built with React, Node.js, and MongoDB, offering a seamless shopping experience and robust backend.</h1></a> 
                </div>
                <div className='p-2 flex flex-col m-2 rounded-lg bg-purple-400
                transition-all ease-in-out group hover:scale-110'>
                  <a href=''> <img src={img4} className="h-[180px] w-full rounded-lg"/>
                ...
                <div className='p-2 flex flex-col m-2 rounded-lg bg-purple-400
                transition-all ease-in-out group hover:scale-110'>
                  <a href='https://sarpmitrachitra.vercel.app/'> <img src={img2} className="h-[180px] w-full rounded-lg"/>
                ...
                <div className='p-2 flex flex-col m-2 rounded-lg bg-purple-400
                transition-all ease-in-out group hover:scale-110'>
                  <a href=''> <img src={img3} className="h-[180px] w-full rounded-lg"/>
